...
class SummaryStatsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsets.symmetric(horizontal: 4.w, vertical: 0.5.h), // Reduced vertical margin
      child: Column(
  ...
  Widget _buildStatCard(
    ...
    final averageCompletion = stats['averageCompletion'] as int? ?? 0;
    final daysWithData = stats['daysWithData'] as int? ?? 0;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 1.5.h),
            _buildProgressIndicator(averageCompletion, accentColor),
            SizedBox(height: 1.5.h),
            Row(
              children: [
                Icon(
